...
export default function Settings() {
  ...
  const load = async () => {
    try {
      setLoading(true);
      const [p, m, g, l, am, confFlag, updateFlag, photoFlag, deliveryPhotoFlag, deliveryProofFlag, ruralKeys, generalDeadlines, storeReleaseFlag, itemFulfillmentFlag, waitingRulesFlag, nfConfigFlag] = await Promise.all([
