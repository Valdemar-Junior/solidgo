...
export interface SyncQueueItem {
  id: string;
  type: 'delivery_confirmation' | 'order_update' | 'assembly_update' | 'return_revert' | 'assembly_confirmation' | 'assembly_return' | 'assembly_undo' | 'delivery_revert' | 'route_completion';
  data: any;
  timestamp: string;
  attempts: number;
  last_attempt?: string;
